...
func main() {
	...
	awsCfg, err := config.LoadDefaultConfig(
		context.Background(),        // empty context for setup
		config.WithRegion(s3Region), // load our config region set in .env
	)
